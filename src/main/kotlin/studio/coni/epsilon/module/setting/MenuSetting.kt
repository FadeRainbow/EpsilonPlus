...
import studio.coni.epsilon.util.graphics.texture.MipmapTexture
...
object MenuSetting : Module(
    ...
    private val shader = setting(
        ...
        if (Thread.currentThread() == EpsilonPlus.mainThread) reset()
    }
    ...
    private var PHOTO_PATH = EpsilonPlus.DEFAULT_CONFIG_PATH + "background/background.jpg"
